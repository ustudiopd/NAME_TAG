...
import { getPrizeDraw, updatePrizeDraw } from '../../../lib/prizeDrawDatabase'
import { getProfilesByEvent } from '../../../lib/database'
import PrizeDrawSettings from '../../../components/PrizeDrawSettings'

export default function PrizeDrawSettingsPage() {
  ...
  const loadPrizeDraw = async () => {
    try {
      ...
      if (data) {
        console.log('새창에서 로드된 prizeDraw:', data)
        console.log('selected_participants:', data.selected_participants)
        setPrizeDraw(data)
      } else {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700">경품추첨 설정을 불러오는 중...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-6xl responsive-container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">경품추첨 설정</h1>
